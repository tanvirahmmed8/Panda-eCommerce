    ...
    ***********************************-->
    <div id="main-wrapper">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    @if (auth()->user()->profile_photo)
                                        <img src="{{ asset('dashboard/uplaods/profile_photos') }}/{{ auth()->user()->profile_photo }}" width="20" alt=""/>
                                    @else
                                        <img src="{{ Avatar::create(Str::upper(auth()->user()->name))->toBase64() }}" width="20" alt=""/>
                                    @endif
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('policy.index') }}">Policy List</a></li>
                            <li><a href="{{ route('policy.create') }}">Policy Add</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('shipping.index') }}" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-settings-2"></i>
				...
				<div class="copyright">
					<p><strong>Gymove Fitness Admin Dashboard</strong> © {{ \Carbon\Carbon::now()->format('Y') }} All Rights Reserved</p>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Tanvir</a> {{ \Carbon\Carbon::now()->format('Y') }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
